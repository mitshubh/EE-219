# -*- coding: utf-8 -*-
"""
Created on Sat Feb 11 13:17:06 2017
...
fpr_svc, tpr_svc, thresholds = roc_curve(test_data.target, probas_[:, 1])
#roc_auc_svc = auc(fpr_svc, tpr_svc)
#plt.plot(fpr_svc, tpr_svc, lw=1, color='red', label='ROC curve (area = %0.2f)' % roc_auc_svc)
